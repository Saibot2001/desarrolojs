function renderCarrito() {
    ...
    if (cantTotalProductos() > 0) {
        ...
        for (const producto of carrito) {
            ...
            <td class="text-end"><button class="btn colorFondo2 btn-sm" onclick="eliminarProductoCarrito(${producto.id})" title="Eliminar Producto"><img src="../icons/tacho.svg" alt="Eliminar Producto" width="16" /></button></td>
            </tr>`;
        }
